export const COPY = {
  en: {
    ...
    adminLoginLead: "Sign in to add services, edit the catalog, and update site settings.",
    ...
    adminDashboardLead:
      "Add or edit subscriptions. Changes save to the live catalog and stay after Node restarts.",
    ...
    adminSyncGithubCatalog: "Sync GitHub catalog",
    adminSyncedGithub: "GitHub catalog applied to the live store.",
    adminImported: "Catalog imported. Storefront updated.",
    adminImportInvalid: "That file is not a valid admin-state.json.",
    adminBack: "Back",
    adminDelete: "Delete",
  ...
  ar: {
    ...
    adminLoginLead: "سجّل الدخول لإضافة الخدمات وتعديل الكتالوج وإعدادات الموقع.",
    ...
    adminDashboardLead:
      "أضف أو عدّل الاشتراكات. تُحفظ التغييرات في الكتالوج المباشر وتبقى بعد إعادة تشغيل الخادم.",
    ...
    adminOfferHint:
      "العروض اختيارية. العرض المنتهي يُخفى من المتجر ويبقى هنا في لوحة المسؤول لتعديله أو حذفه.",
    offerEid: "عرض العيد",
    ...
    adminSyncGithubCatalog: "مزامنة كتالوج GitHub",
    adminSyncedGithub: "تم تطبيق كتالوج GitHub على المتجر.",
    adminImported: "تم استيراد الكتالوج. تم تحديث واجهة المتجر.",
    adminImportInvalid: "هذا الملف ليس admin-state.json صالحًا.",
    adminBack: "رجوع",
    adminDelete: "حذف",
