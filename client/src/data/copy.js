export const COPY = {
  en: {
    ...
    adminLoginLead: "Sign in to manage complaint email, WhatsApp numbers, and About Us.",
    ...
    adminDashboardLead:
      "The subscription catalog is edited in the project source (client/src/data/catalog.js). Use these options for site settings only.",
  ...
  ar: {
    ...
    adminLoginLead: "سجّل الدخول لإدارة بريد الشكاوى وأرقام واتساب ونبذة من نحن.",
    ...
    adminDashboardLead:
      "كتالوج الاشتراكات يُعدَّل في مصدر المشروع (client/src/data/catalog.js). هذه الخيارات لإعدادات الموقع فقط.",
